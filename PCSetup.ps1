...
function LayoutDesign {
    ...
    Import-StartLayout -LayoutPath "c:\build\pcbuild-10\LayoutModification.xml" -MountPath $env:SystemDrive\
    }
    
function ApplyDefaultApps {
    dism /online /Import-DefaultAppAssociations:c:\build\pcbuild-10\AppAssociations.xml
}
