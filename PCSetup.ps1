...
function SetPCName {
    ...
    # This function creates VisualBasic pop-up prompts which ask for this information to be input. You can change these as needed to suite your MSP
...
function InstallApps {
    ...
    choco install adobereader 7zip microsoft-edge notepadplusplus cutepdf googlechrome vlc -y
...
function LayoutDesign {
    ...
    Import-StartLayout -LayoutPath "c:\build\pcbuild-9\LayoutModification.xml" -MountPath $env:SystemDrive\
    }
    
function ApplyDefaultApps {
    dism /online /Import-DefaultAppAssociations:c:\build\pcbuild-9\AppAssociations.xml
}
...
function CMSPower {
    ...
    POWERCFG -CHANGENAME 381b4222-f694-41f0-9685-ff5bb260aaaa "CMS Power Management"
