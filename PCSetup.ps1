...
function LayoutDesign {
    ...
    Import-StartLayout -LayoutPath "c:\build\pcbuild-2\LayoutModification.xml" -MountPath $env:SystemDrive\
    }
    
function ApplyDefaultApps {
    dism /online /Import-DefaultAppAssociations:c:\build\pcbuild-2\AppAssociations.xml
}
