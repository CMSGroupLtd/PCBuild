...
function InstallApps {
    ...
    choco install adobereader 7zip microsoft-edge notepadplusplus cutepdf -y
...
function LayoutDesign {
    ...
    Import-StartLayout -LayoutPath "c:\build\pcbuild-3\LayoutModification.xml" -MountPath $env:SystemDrive\
    }
    
function ApplyDefaultApps {
    dism /online /Import-DefaultAppAssociations:c:\build\pcbuild-3\AppAssociations.xml
}
